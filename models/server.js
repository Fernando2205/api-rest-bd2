...
class Server {
  ...
  routes () {
    ...
    this.app.use(this.pathsMySql.heroes, require('../routes/heroes.routes'))
    this.app.use(this.pathsMySql.peliculas, require('../routes/peliculas.routes'))
    this.app.use(this.pathsMySql.protagonistas, require('../routes/protagonistas.routes'))
  }
